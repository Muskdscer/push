...
import com.push.common.webfacade.bo.out.KxDistributeCallbackOrderStatusBO;
...
/**
 * Description:
 * Create DateTime: 2020/8/14 10:15
 *
 * 
...
@Slf4j
@Service
public class KxDistributeShopProcessor implements ShopProcessor {
    @Resource
    ...
    public ShopUserInfo getShopUserInfo(String param) {
        KxDistributeCallbackOrderStatusBO callbackOrderStatusBO = JSON.parseObject(param, KxDistributeCallbackOrderStatusBO.class);
    ...
    private TpPhoneOrderCallBack createTpPhoneOrderCallBack(KxDistributeCallbackOrderStatusBO bo) {
